...
{
    public class GraphPaneToggleButtonViewModel : BindableBase
    {
        private ImageBrush _uncheckedStateImageBrush;
        public ImageBrush UncheckedStateImageBrush { get { return _uncheckedStateImageBrush; } set { SetProperty(ref _uncheckedStateImageBrush, value);
            if (!IsChecked)
            {
